...
public class SearchFiles {
  ...
  public static void doPagingSearch(BufferedReader in, IndexSearcher searcher, Query query,
    ...
    Arrays.sort(hits, (o1, o2) -> {
      ...
      try {
        score1 = omega * o1.score +
                (1 - omega) * Float.parseFloat(searcher.doc(o1.doc).get("pageRankScore"));
      } catch (IOException e) {
        e.printStackTrace();
      }
      try {
        score2 = omega * o2.score +
                (1 - omega) * Float.parseFloat(searcher.doc(o2.doc).get("pageRankScore"));
      } catch (IOException e) {
        e.printStackTrace();
      }
    ...
    while (true) {
      ...
      for (int i = start; i < end; i++) {
        ...
        if (path != null) {
          ...
          String pageRankScore = doc.get("pageRankScore");
          if (url != null) {
            System.out.println("   SCORE: " + pageRankScore);
          }
        } else {
